<%-- 
    ...
    Created on : Oct 31, 2021, 10:09:41 AM
    Author     : LNV
--%>
        ...
        <div class="app__content">
            <div class="grid wide">
                ...
                <div class="account__content">
                    ...
                    <div class="tabs1">
                        <a class="tab-item active" href="bookingHistory">Lịch sử đặt chỗ</a>
                        <a class="tab-item" href="Account.jsp">Cài đặt tài khoản</a>
                    </div>
                    ...
                    <table class="timetable_sub">
                        ...
                        <tbody>
                            <c:forEach items="${bookings}" var="o">
                            <tr class="rem1">
                                <td class="invert">${o.getBooking().bookingID}</td>
                                <td class="invert">
                                    <div class="quantity">
                                        <div class="quantity-select">
                                            <div class="entry value">
                                                <span>${o.getHomestayName()}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="">${o.getBooking().check_in}</td>
                                <td class="invert">${o.getBooking().check_out}</td>
                                <%--                                <td class="invert">${o.totalPrice}</td>--%>
                            </tr>
                            </c:forEach>
                        </tbody>
                    </table>
