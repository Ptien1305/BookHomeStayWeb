            ...
            <div class="app__content">
                <div class="grid wide">
                    ...
                    <div class="update__content">
                        <h1 style="text-align: center">Cập nhật địa điểm</h1>
                        ...
                        <form action="editLocation" method="post">
                            <table class="update__content-list">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input value="${locations.id}" type="text" readonly name="id" placeholder="id" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                    <input value="${locations.name}" required type="text" name="name" placeholder="Tên địa điểm" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
